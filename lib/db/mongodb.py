...
class MongoDB:
	...
	def show_table_data_count_by_column_and_value_and_column(self, db_name, table_name, column_name, value, column_name2):
		return self.db[db_name][table_name].count_documents({column_name: value, column_name2: {'$exists': True}})
